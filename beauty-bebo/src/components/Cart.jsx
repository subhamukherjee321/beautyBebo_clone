...
const Cart = () => {
  ...
  async function getData() {
    const data = await fetch(
      "https://mock-server-app-033a.onrender.com/cart"
    ).then((d) => d.json());
    setcartitem(data);
  }
  ...
  function handledelete(id) {
    console.log("deleted");
    fetch(`https://mock-server-app-033a.onrender.com/cart/${id}`, {
      method: "DELETE",
    }).then((result) => {
        ...
        <div className="cartmaincontainer_at">
          <div className="showcartproducts_at">
            <div className="showcartproductshead_at cartheadhead_at">
              <div className="itemdiv_at item_item_at">
                <b>Item</b>
              </div>
                    ...
                    <div className="cartbox_full">
                      ...
                      <button
                        onClick={() => {
                          ...
                          fetch(
                            `https://mock-server-app-033a.onrender.com/cart/${e.id}`,
                            {
                              method: "DELETE",
                            }
                          );
            ...
            <div className="zipcode">
              <div>
                ...
                <div className="spediv_at">
                  <span>Subtotal:</span>
                  <span className="spedivspan_at">₹{total()}</span>
                </div>
                ...
                <div className="spediv_at">
                  ...
                  <span className="gst_at">₹ {total() + 40}</span>
                </div>
